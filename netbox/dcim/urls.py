...
urlpatterns = [
    ...
    url(r'^devices/(?P<pk>\d+)/stacking/$', views.DeviceStackingView.as_view(), name='device_stacking'),
    url(r'^devices/(?P<pk>\d+)/convert/$', views.DeviceConvertView.as_view(), name='device_convert'),
